              ...
              <div className="flex items-center justify-between gap-4 shrink-0">
                ...
                <div className="flex gap-2 shrink-0 items-center">
                  <button 
                    ...
                    className="relative inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-lg group shrink-0 shadow-sm transition-transform duration-150 active:scale-[0.98] cursor-pointer"
                  >
                    <span
                    ...
                    ></span>
                    <span className="relative text-sm sm:text-base font-semibold flex items-center gap-1 sm:gap-2">
